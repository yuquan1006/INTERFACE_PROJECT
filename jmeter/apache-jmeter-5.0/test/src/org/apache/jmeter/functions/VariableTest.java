...
public class VariableTest extends JMeterTestCase {
    ...
    public void variableTest2() throws Exception {
        vars.put("memberCode", "123456789");
        AbstractFunction function = new Groovy();
        Collection<CompoundVariable> params = new LinkedList<>();
        params.add(new CompoundVariable("1${memberCode}"));
        function.setParameters(params);
        String ret = function.execute(null, null);
        assertEquals("1123456789",ret);
    }
