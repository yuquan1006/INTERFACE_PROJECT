...
public class BoscApiTest extends AbstractTestNGSpringContextTests {
    ...
    @Resource(name = "clientBoscSecurityService")
    private BoscSecurityService boscSecurityService;

    private static final Logger logger = LoggerFactory.getLogger(BoscApiTest.class);
...
//    mock公私钥
//    private static final String privateKeyPath = "/opt/mock/bosc/privateKey.p12";
//    private static final String privateKeyPassword = "password";
//    private static final String publicKeyPath = "/opt/mock/bosc/publicKey.cer";

    private String post(String tranCode, Map<String, String> bodyMap) throws Exception {
...
/*        SvsSign signer = new SvsSign();
        ...
        String signature = signer.signData(signData.getBytes(BoscConstants.GBK)).replace("\r\n", "");
...
/*        SvsVerify verifier = new SvsVerify();
        ...
        int verifyResult = verifier.verifySign(respSignData.getBytes(BoscConstants.GBK),respSignature);
    ...
    private void putJSONObjectToMap(JSONObject jsonObject, Map<String, String> map){
    ...
    //子账户开户
    @Test
    public void testIBPS_OPENACCT_000001() throws Exception {
        //交易代码
...
//        bodyMap.put("ExpDay", "20261006"); //非必填
    ...
    //账户信息修改
    @Test
    public void testIBPS_OPENACCT_000002() throws Exception {
        //交易代码
...
//        bodyMap.put("ReservedPhone", "15261471747"); //非必填
    ...
    //账户信息查询
    @Test
    public void testIBPS_OPENACCT_000004() throws Exception {
        //交易代码
...
//        bodyMap.put("SubAcctNo", ""); //非必填
    ...
    //账户信息签约
    @Test
    public void testIBPS_IBS_140002() throws Exception {
        //交易代码
    ...
    //代付交易状态查询
    @Test
    public void testIBPS_IBS_110018() throws Exception {
        //交易代码
